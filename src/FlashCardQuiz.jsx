                                            ...
                                            {players.map((player, index) => (
                                                <div key={index} className="flex items-center justify-between bg-white rounded-lg p-2 border-2 border-[#D4A574]">
                                                    <div className="flex items-center gap-2 flex-1">
                                                        <span className="text-xl font-bold text-[#A0253B] min-w-[28px]">
                                                            {index + 1}.
                                                        </span>
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        <button
                                                            ...
                                                            disabled={index === 0}
                                                            className={`w-8 h-8 rounded-lg font-bold transition-all text-lg ${index === 0 ? 'bg-gray-200 text-gray-400' : 'bg-[#6B8E23] text-white active:bg-[#556B1D]'}`}
                                                        >
                                                            ▲
                                                        </button>
                                                        <button
                                                            ...
                                                            className={`w-8 h-8 rounded-lg font-bold transition-all text-lg ${index === players.length - 1 ? 'bg-gray-200 text-gray-400' : 'bg-[#6B8E23] text-white active:bg-[#556B1D]'}`}
                                                        >
                                                            ▼
                                                        </button>
                                                        <button
                                                            onClick={() => handleRemovePlayer(index)}
                                                            className="w-8 h-8 bg-[#A0253B] text-white rounded-lg font-bold active:bg-[#8B1538] transition-all text-lg"
                                                        >
                                                            🗑️
                                                        </button>
                                                    </div>
